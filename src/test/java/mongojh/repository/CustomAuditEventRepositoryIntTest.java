package mongojh.repository;

import mongojh.ConferenceApp;
import mongojh.config.Constants;
import mongojh.config.audit.AuditEventConverter;
import mongojh.domain.PersistentAuditEvent;
...
import static mongojh.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
